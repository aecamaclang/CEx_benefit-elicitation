Compile and manage expert estimates
================
Abbey Camaclang
27 Mar 2024
...
2) Compiles expert estimates from multiple .csv files into single
table.  
3) Performs data cleaning as needed (e.g., removing example rows or
empty rows, standardizing variable names, converting B’s into
Counterfactual values and X’s into NAs).
