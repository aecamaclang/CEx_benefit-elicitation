Calculate benefit and aggregate
================
Abbey Camaclang
27 Mar 2024

This script reads compiled data (.csv files) generated by compile.R,
counts the number of estimates for each Biodiversity feature, calculates
the Benefit then aggregates (averages) the estimates. Also aggregates
estimates of probability of success of the project.
